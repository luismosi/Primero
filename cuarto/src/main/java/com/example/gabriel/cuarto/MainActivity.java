package com.example.gabriel.cuarto;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final RadioGroup sex = (RadioGroup) findViewById(R.id.sexo);
        ...
        botton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                hobbies = "";
                ver_hobbies();
                TextView resultado = (TextView) findViewById(R.id.datosf);
...
// Apply the adapter to the spinner
    ...
    public void ver_hobbies() {
            if (((CheckBox) findViewById(R.id.bailar)).isChecked()) {
                hobbies += "bailar ";
            ...
            if (((CheckBox) findViewById(R.id.nadar)).isChecked()) {
                hobbies += "nadar ";
